...
$CONFIGURATIONFILE="Y:\Automated-Install\Config-Files\ConfigurationFile_2012_Cluster_DBE_InstallFailoverCluster.ini"
...
#Set sql settings
$SQLSYSADMINACCOUNTS="CLOSEBROTHERSGP\SQL-D-RDC2SQLV01-SysAdmin"
$SQLCOLLATION="Latin1_General_CI_AS"

#----------------end setting user variables-----------------

#------------------Cluster variables---------------------------
#$FAILOVERCLUSTERIPADDRESSES="IPv4;10.160.24.40;Cluster Network 2;255.255.255.0"
$FAILOVERCLUSTERNETWORKNAME="RDC2SQLV01"
...
$process=(Start-Process -Verb runas -FilePath $SETUPPATH -ArgumentList  "/CONFIGURATIONFILE=$CONFIGURATIONFILE /FAILOVERCLUSTERNETWORKNAME=$FAILOVERCLUSTERNETWORKNAME /INSTANCENAME=$INSTANCENAME /INSTANCEID=$INSTANCENAME /SQLSVCACCOUNT=$SQLSVCACCOUNT /SQLSVCPASSWORD=$SQLSVCPASSWORD /AGTSVCACCOUNT=$AGTSVCACCOUNT /AGTSVCPASSWORD=$AGTSVCPASSWORD /SQLUSERDBDIR=$SQLUSERDBDIR /SQLUSERDBLOGDIR=$SQLUSERDBLOGDIR /SQLBACKUPDIR=$SQLBACKUPDIR /SQLTEMPDBDIR=$SQLTEMPDBDIR /SQLSYSADMINACCOUNTS=$SQLSYSADMINACCOUNTS /SQLCOLLATION=$SQLCOLLATION /IACCEPTSQLSERVERLICENSETERMS /QS" -Wait -PassThru)
...
if($process.ExitCode -eq 0)
{
    ...
    Invoke-Expression "Y:\Automated-Install\ConfigureSQL_FailoverCluster.ps1 $FAILOVERCLUSTERNETWORKNAME $ScriptRoot $Version"
